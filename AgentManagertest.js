	...
	async.series([
	    function(callback){
			...
			if (agentType == 'NegoChatAgent'){
				...
				async.series([
				    function(callback){
//				        agent = new NegoChatAgent(domains['Kitchen'], role, opponentRole, gameid+"test",country1);
			...
			if (agentType == 'NewAgent'){
				...
				async.series([
				    function(callback){
				        //agent = new NewAgent(domains['Kitchen'], role, opponentRole, gameid+"test",country1);
